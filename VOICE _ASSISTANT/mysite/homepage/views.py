...
attachment_dir = 'C:/Users/athul/Desktop/'
...
def login_view(request):
    ...
    if request.method == 'POST':
        ...
        while flag:
            ...
            if addr != 'N':
                texttospeech("You meant " + addr + ". Say confirm to confirm or no to enter again.", file + i)
                i = i + str(1)
            else:
            ...
            say = speechtotext(10)
            say = say.strip() # Strip leading and trailing whitespaces
            if say.lower() == 'confirm':
                flag = False
            else:
                texttospeech("Enter your Email again.", file + i)
                i = i + str(1)
        ...
        while flag:
            ...
            if passwrd != 'N':
                texttospeech("You meant " + passwrd + ". Say confirm to confirm or no to enter again.", file + i)
                i = i + str(1)
            else:
                texttospeech("Could not understand what you meant. Please try again.", file + i)
                i = i + str(1)
            ...
            if say.lower() == 'confirm':
                ...
                texttospeech("Enter your password again.", file + i)
                i = i + str(1)
        ...
        if passwrd.lower() == "project@123":
            passwrd="pzmtnzrrpwoasoko"
        print(passwrd)
        ...
        while flag1:
            while flag:
                ...
                if to != 'N':
                    ...
                    texttospeech("You meant " + to + " say confirm to confirm or no to enter again", file + i)
                    i = i + str(1)
                    say = speechtotext(10)
                    if say.lower()=="confirm":
                        toaddr.append(to)
...
def trash_view(request):
    ...
    if request.method == 'POST':
        ...
        conn.login(addr, passwrd)
        try:
            conn.select('"{}/Bin"'.format(conn.namespace()[1][0][0].decode("utf-8")))
